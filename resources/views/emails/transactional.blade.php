...
<body style="margin: 0; width: 100%; background-color: #fffbeb; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
              ...
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  <a href="https://maizzle.com">
                    <img src="logo.png" width="70" alt="Maizzle" style="max-width: 100%; vertical-align: middle">
                  </a>
                  <div role="separator" style="line-height: 24px">&zwj;</div>
                  ...
                  <div>
                    <a href="https://maizzle.com" style="margin: 0 0 24px; display: inline-block; border-radius: 4px; background-color: #020617; padding: 16px 24px; font-size: 16px; line-height: 1; font-weight: 600; color: #f8fafc; text-decoration: none" class="hover-bg-slate-800">
                      <!--[if mso]>
              ...
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px">
                  <p style="margin: 0; font-size: 12px; color: #64748b">
                    &copy; 2024 Maizzle. All rights reserved.
                  </p>
                </td>
              </tr>
            </table>
